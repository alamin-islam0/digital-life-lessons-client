...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white dark:bg-gray-800 dark:bg-gray-900 shadow-md sticky top-0 z-40 transition-colors">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            {user ? (
              ...
              <div className="flex items-center gap-3">
                <Link
                  to="/login"
                  className="px-4 py-2 text-primary dark:text-white dark:text-white font-semibold hover:text-secondary dark:hover:text-secondary transition-colors"
                >
                  Login
                </Link>
                <Link
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="md:hidden bg-white border-t border-gray-100 dark:bg-gray-600 dark:border-gray-700 max-h-[calc(100vh-4rem)] overflow-y-auto">
                ...
                <>
                  ...
                  <div className="px-4 py-3 bg-gray-50 dark:bg-gray-700 rounded-lg mb-2">
                    ...
                    <Link
                      ...
                      className="flex items-center gap-3 space-y-2 px-4 py-3 hover:bg-gray-50 dark:bg-gray-700 rounded-lg transition-colors dark:hover:text-secondary"
                    >
                    ...
                    <Link
                      ...
                      onClick={() => setIsOpen(false)}
                      className="flex items-center gap-3 px-4 py-3 hover:bg-gray-50 dark:bg-gray-700 rounded-lg transition-colors dark:hover:text-secondary"
                    >
                    ...
                    <button
                      onClick={handleLogout}
                      className=" flex items-center gap-3 px-4 py-3 hover:bg-error/10 rounded-lg transition-colors text-error w-full text-left dark:hover:text-secondary"
                    >
                      <LogOut className="w-4 h-4" />
                      Logout
                    </button>
