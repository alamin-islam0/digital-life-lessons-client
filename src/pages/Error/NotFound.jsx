      ...
      <div className="text-center max-w-lg">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <button
            ...
            className="px-8 py-3 bg-white text-gray-700 dark:text-gray-300 rounded-xl font-bold hover:bg-gray-50 dark:bg-gray-700 transition-colors border border-gray-200 dark:border-gray-700 flex items-center justify-center gap-2"
          >
